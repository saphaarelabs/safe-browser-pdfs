...
const Index = () => {
  ...
  useEffect(() => {
    document.title = "PDF Tools — Free Online PDF Editor, Converter & Toolkit";
  }, []);
      ...
      <section className="border-b py-20 md:py-28">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-muted-foreground text-lg">
            {tools.length} tools to merge, split, compress, convert, and edit PDFs — entirely in your browser.
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-sm text-muted-foreground mb-8">
            {tools.length} free tools — everything happens in your browser
          </p>
